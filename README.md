# [SOLVED] How-To-Catch-Sqlserver-Timeout-Exceptions
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/how-to-catch-sqlserver-timeout-exceptions)
>
...
Use the SqlException class and check for the 'Timeout' error code, which is 1205.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/how-to-catch-sqlserver-timeout-exceptions)**
